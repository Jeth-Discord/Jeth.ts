...
module.exports = class tapa extends Command {
  ...
  async run(message, args) {
    ...
    if (!slapUser) return message.channel.createMessage("Mencione alguém para da um tapa!");
    ...
    let slapEmbed = new Discord.MessageEmbed()
      ...
      .setFooter(`Tapa dado por ${message.author.username}`, message.author.avatarURL)

    message.channel.createMessage(slapEmbed)
  }
}