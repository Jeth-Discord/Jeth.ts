...
module.exports = class Ajuda extends Command {
    ...
    async run(message, args) {
        ...
        embed.setThumbnail(message.member.guild.iconURL({ dynamic: true, size: 1024 }))
        ...
        message.channel.createMessage(`${message.author} Não se esqueça de votar em mim! <:7875_christmaspog:828828587926093924>`, embed)
            .catch(() => {
