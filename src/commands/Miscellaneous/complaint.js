...
module.exports = class chat extends Command {
    ...
    async run(message, args) {
        ...
        await this.client.channels.get('838234183566360636').send(reportembed)
        await this.client.channels.get('838234183566360636').send(`Reported by: ${`${message.author.username}#${message.author.discriminator}`}`)
