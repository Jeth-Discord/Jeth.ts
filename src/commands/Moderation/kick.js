...
module.exports = class kick extends Command {
   ...
   async run(message, args) {
      ...
      const warnembed18 = new Discord.MessageEmbed()
         ...
         .setDescription(`🚫 Você foi expulso do servidor ${message.member.guild.name}`)
         .setColor("#ff0000")
      ...
      if (!message.member.hasPermission("KICK_MEMBERS")) return message.channel.createMessage(embedA)
      ...
      message.channel.createMessage(warnembed13);
      membro18.send(warnembed18);
      await message.member.guild.member(membro18).kick(razao13)
   }
};